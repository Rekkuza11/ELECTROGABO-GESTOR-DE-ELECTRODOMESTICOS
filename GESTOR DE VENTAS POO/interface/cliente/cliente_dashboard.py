...
def abrir_dashboard_cliente(app, id_usuario: str) -> None:
    """
    Oculta la ventana de login y abre el dashboard del cliente.
 
    Args:
        app        — instancia de App (ctk.CTk), se oculta durante el dashboard.
        id_usuario — ID del cliente autenticado.
    """
    app.withdraw()
...
class _VentanaDashboardCliente(ctk.CTkToplevel):
    """Toplevel del dashboard cliente."""
...
def _vista_inicio_cliente(parent: ctk.CTkFrame, id_usuario: str) -> None:
    """Panel de bienvenida con resumen de compras del cliente."""
    ...
    # Obtener datos del cliente desde reportes
    try:
